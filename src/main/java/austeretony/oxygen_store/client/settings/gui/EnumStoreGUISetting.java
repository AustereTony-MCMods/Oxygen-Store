package austeretony.oxygen_store.client.settings.gui;
...
public enum EnumStoreGUISetting {

    //Alignment

    STORE_MENU_ALIGNMENT("alignment_store_menu", EnumValueType.INT, String.valueOf(0));
    ...
    EnumStoreGUISetting(String key, EnumValueType type, String baseValue) {
        this.key = key;
        this.type = type;
    ...
    public static void register() {
        for (EnumStoreGUISetting setting : values())
